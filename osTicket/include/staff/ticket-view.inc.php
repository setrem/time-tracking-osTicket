...
//Get the goodies.
// CHANGED!
$ticket_time_tracking_running = $ticket->isTicketTimeTrackingRunning(null);
// CHANGED!
...
<?php           if ($thisstaff->hasPerm(Email::PERM_BANLIST)
                ...
                <form
                    ...
                    class="post-response action-button"
                    data-placement="bottom" data-toggle="tooltip"
                    onclick="this.submit()"
                    title="<?php echo __($ticket_time_tracking_running ? 'Stop' : 'Start'); ?>"
                    action="tickets.php?id=<?php echo $ticket->getId(); ?>">
                    <?php csrf_token(); ?>
                    <input type="hidden" name="a" value="start-stop" />
                    <a href="#" onclick="this.parentNode.submit()">
                        <i class="<?php echo __($ticket_time_tracking_running ? 'icon-stop' : 'icon-play'); ?>"></i>
                    </a>
                </form>
                <!-- CHANGED! -->
                <?php
